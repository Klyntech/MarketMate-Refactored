...
from marketmate.data.cache import store_live_candles
...
from marketmate.strategy.bias import get_htf_bias, compute_ema
...
from marketmate.strategy.gates import is_high_impact_news
from marketmate.strategy.scoring import compute_confidence, compute_weighted_score
...
from marketmate.strategy.liquidity import _strict_swing_highs, _strict_swing_lows
from marketmate.strategy.dedup import is_duplicate_signal, get_effective_cooldown, get_effective_flip_cooldown
...
class SignalEngine:
    ...
    async def _run_gates(self, symbol: str) -> GateResult:
        ...
        if _live_frames:
            ...
            asyncio.create_task(store_live_candles(symbol, _live_frames, _mm))
