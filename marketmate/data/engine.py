...
from marketmate.data.providers import get_available_providers
from marketmate.data.validators import validate_ohlcv, validate_freshness
from marketmate.data.transformers import (
    resample_candles,
    normalize_outputs,
    handle_timezone,
)
from marketmate.data import cache as candle_cache
...
class MarketDataEngine:
    ...
    def resample_candles(
        ...
        Delegates to ``marketmate.data.transformers.resample_candles``.
        """
    ...
    def normalize_outputs(self, df: pd.DataFrame) -> pd.DataFrame:
        ...
        Delegates to ``marketmate.data.transformers.normalize_outputs``.
        """
