...
export default function SignupPage() {
  ...
  const handleOAuthSignup = async (provider: "github" | "google") => {
    setIsLoading(true)
    setError("")
    await signIn(provider, { callbackUrl: "/desk" })
  }
        ...
        <div className="relative z-10 flex flex-col justify-between p-12 w-full">
          ...
          <div className="max-w-md">
            <h1 className="text-4xl font-bold text-foreground mb-6 leading-tight text-balance">
              Start Building with Market Intelligence
            </h1>
            <p className="text-lg text-muted-foreground mb-8">
              Create your account to access real-time market state, conviction signals, and structured intelligence infrastructure.
            </p>
            ...
            <div className="space-y-4">
              {[
                ...
                "7-Brain MATE AI interpreter",
                "Access to MarketMate Desk",
              ].map((feature, index) => (
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8">
        <div className="w-full max-w-md">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-muted-foreground">Start building with real-time market intelligence</p>
          </div>
          ...
          <div className="space-y-3 mb-6">
            <Button 
              type="button"
              variant="outline" 
              className="w-full h-12 border-border hover:bg-secondary hover:border-primary/50 transition-all"
          ...
          <form onSubmit={handleEmailSignup} className="space-y-5">
            ...
            <div className="flex items-start gap-3">
              <button
                ...
                className="mt-1 flex items-center justify-center w-4 h-4 rounded border border-border bg-secondary shrink-0"
              >
                {agreedToTerms && <Check className="w-3 h-3 text-primary" />}
              </button>
